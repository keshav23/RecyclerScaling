...
class AudioChatProfileView @JvmOverloads constructor(
    context: Context,
    ...
    init {
        context.getSystemService(Context.LAYOUT_INFLATER_SERVICE).apply {
            inflate(context, R.layout.audio_chat_profile_view, this@AudioChatProfileView)
        }
        profilePicView = findViewById<ImageView>(R.id.audio_profile_user_view)
        profilePicBorderView = findViewById<ImageView>(R.id.audio_profile_user_border_view)
        profileNameView = findViewById<TextView>(R.id.audio_chat_profile_name)
        hostFrameView = findViewById<ImageView>(R.id.audio_profile_host_frame)
        userLevelView = findViewById<ImageView>(R.id.audio_chat_user_level)
        hostProfilePicTranslucentView = findViewById<ImageView>(R.id.audio_profile_host_greyed_view)
        lockView = findViewById<ImageView>(R.id.audio_profile_lock_view)
    }
